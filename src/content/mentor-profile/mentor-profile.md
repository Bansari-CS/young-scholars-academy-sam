...
testimonials:
  ...
  items:
    ...
    - quote: We've tried countless online courses, but nothing compares to the community here. The small class sizes mean my child isn't just a face on a screen-they're a valued member of a team.
      name: Michelle T.
      meta: Parent of a 14-year-old scholar
      highlight: false
findClassCta:
  title: Find the Right Class for Your Child
  description: Not sure where to start? Browse all courses or use our fit finder tool to match with the perfect learning path.
  primaryCtaLabel: Find My Child's Fit
  primaryCtaHref: "#"
